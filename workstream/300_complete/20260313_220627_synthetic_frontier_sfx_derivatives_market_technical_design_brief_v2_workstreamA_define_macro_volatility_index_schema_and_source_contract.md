...
## Context
- `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams`
...
- [x] 2. Author the macro volatility index contract artifacts covering required fields, source taxonomy, per-instrument rules, and a worked phase-1 example.
  ...
  - [x] Evidence: created `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema_and_source_contract.md`, `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema.json`, and `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/verification/workstream_a1_ngn_vol_example.json`.
...
- Evidence-Type: file_output
  - Artifact: `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema_and_source_contract.md`
  ...
  - Status: captured
- Evidence-Type: file_output
  - Artifact: `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema.json`
  ...
  - Status: captured
- Evidence-Type: file_output
  - Artifact: `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/verification/workstream_a1_ngn_vol_example.json`
...
## Changes Made
- Added `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema_and_source_contract.md`
...
- Added `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_a1_macro_volatility_index_schema.json`
  - defines a machine-readable contract for `input_observation` and `published_index_output` payloads under version `a1.v1`.
- Added `ep_003_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/verification/workstream_a1_ngn_vol_example.json`
