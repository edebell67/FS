...
- Target artifact: `C:\Users\edebe\eds\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\solution\workstreams\D\d3_circuit_breaker_state_machine_and_staged_reopening_rules.md`
...
- [x] 2. Author the D3 design artifact with halt triggers, state machine transitions, staged reopening controls, and operator status outputs.
  - [x] Test: `rg -n "HALTED|REOPEN_STAGE_1|depth_recovery_requirement|source_stability_requirement|manual override" "C:\\Users\\edebe\\eds\\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\\solution\\workstreams\\D\\d3_circuit_breaker_state_machine_and_staged_reopening_rules.md"` returns matches covering the required design elements.
  - Evidence: Artifact created at `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/D/d3_circuit_breaker_state_machine_and_staged_reopening_rules.md`; validation matched state names, recovery requirement sections, and emergency-only manual override constraints.
...
- Evidence-Type: file_output
  - Artifact: `C:\Users\edebe\eds\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\solution\workstreams\D\d3_circuit_breaker_state_machine_and_staged_reopening_rules.md`
...
- Added `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/D/d3_circuit_breaker_state_machine_and_staged_reopening_rules.md` as the Workstream D design deliverable for circuit-breaker behavior.
...
- `rg -n "HALTED|REOPEN_STAGE_1|depth_recovery_requirement|source_stability_requirement|manual override" "C:\Users\edebe\eds\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\solution\workstreams\D\d3_circuit_breaker_state_machine_and_staged_reopening_rules.md"`
...
- `rg -n "index divergence|source instability|depth collapse|staged reopening|automated staged rules|emergency override" "C:\Users\edebe\eds\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\solution\workstreams\D\d3_circuit_breaker_state_machine_and_staged_reopening_rules.md"`
