...
- Existing upstream artifact available in workspace:
  ...
  - `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/verification/workstream_a1_ngn_vol_example.json`
...
- [x] 2. Add executable validation logic that enforces conservative leverage and exposure posture plus upstream reference integrity.
  - [x] Test: `python C:\Users\edebe\eds\ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2\solution\workstreams\workstream_f2_validate_phase_1_listing_pack.py`; pass if command prints `phase_1_pack_ok`.
...
- Evidence-Type: diff
  - Artifact: `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_f2_phase_1_listing_pack.json`, `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_f2_validate_phase_1_listing_pack.py`, `tests/test_sfx_phase_1_listing_pack.py`
...
- 2026-03-16 Europe/London: Inspected `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2` and found the existing A1 schema and verification sample under `solution/workstreams` and `verification`, establishing the target artifact layout for this task.
...
- Added `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_f2_phase_1_listing_pack.json` with:
...
- Added `ep_synthetic_frontier_sfx_derivatives_market_technical_design_brief_v2/solution/workstreams/workstream_f2_validate_phase_1_listing_pack.py` with:
