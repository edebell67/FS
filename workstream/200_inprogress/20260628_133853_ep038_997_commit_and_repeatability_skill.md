...
- [ ] 3. Commit scoped EP038 and skill artefacts to git.
  - Test: `git show --stat --oneline HEAD` confirms commit includes EP038/skill files.
  - Evidence: planned
- [ ] 4. Push to GitHub if remote/auth allows.
  - Test: `git push` result or blocker recorded.
  - Evidence: planned
