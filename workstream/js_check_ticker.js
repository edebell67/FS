        ...
        function updateTicker(tasks) {
             ...
             const sortedAll = [...tasks].filter(t => !["000_backlog", "100_todo", "200_inprogress", "300_complete", "400_failed"].includes(t.folder)).sort((a,b) => b.timestamp.localeCompare(a.timestamp));
