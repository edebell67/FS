(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-alkemist-build-and-decorate-ltd`;
  widget.dataset.client = "batch02_alkemist_build_and_decorate_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("ALKEMIST BUILD AND DECORATE LTD private-review assistant is currently unavailable.");
