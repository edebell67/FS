(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-best-van-man-ltd`;
  widget.dataset.client = "batch02_best_van_man_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Best Van & Man Ltd private-review assistant is currently unavailable.");
