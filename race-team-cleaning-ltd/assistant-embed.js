(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-race-team-cleaning-ltd`;
  widget.dataset.client = "batch02_race_team_cleaning_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Race Team Cleaning Ltd private-review assistant is currently unavailable.");
