(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-exall-roofing-ltd`;
  widget.dataset.client = "batch02_exall_roofing_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("EXALL ROOFING LTD private-review assistant is currently unavailable.");
