(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-serenity-therapeutic-massage-and-beauty-ltd`;
  widget.dataset.client = "batch02_serenity_therapeutic_massage_and_beauty_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("SERENITY THERAPEUTIC MASSAGE AND BEAUTY LTD private-review assistant is currently unavailable.");
