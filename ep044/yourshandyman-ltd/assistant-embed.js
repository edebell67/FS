(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-yourshandyman-ltd`;
  widget.dataset.client = "batch02_yourshandyman_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("YoursHandyMan Ltd. private-review assistant is currently unavailable.");
