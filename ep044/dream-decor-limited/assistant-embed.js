(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-dream-decor-limited`;
  widget.dataset.client = "batch02_dream_decor_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Dream Decor Limited private-review assistant is currently unavailable.");
