(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-sterling-albion-roofing-services-ltd`;
  widget.dataset.client = "batch02_sterling_albion_roofing_services_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Sterling Albion roofing services ltd private-review assistant is currently unavailable.");
