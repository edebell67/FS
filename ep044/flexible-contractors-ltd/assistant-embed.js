(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-flexible-contractors-ltd`;
  widget.dataset.client = "batch02_flexible_contractors_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Flexible Contractors Ltd private-review assistant is currently unavailable.");
