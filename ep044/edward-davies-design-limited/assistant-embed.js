(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-edward-davies-design-limited`;
  widget.dataset.client = "batch02_edward_davies_design_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Edward Davies Design Limited private-review assistant is currently unavailable.");
