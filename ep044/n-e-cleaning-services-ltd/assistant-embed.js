(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-n-e-cleaning-services-ltd`;
  widget.dataset.client = "batch02_n_e_cleaning_services_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("N&E Cleaning Services Ltd private-review assistant is currently unavailable.");
