(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-mc-electrician-ltd`;
  widget.dataset.client = "batch02_mc_electrician_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("MC Electrician LTD private-review assistant is currently unavailable.");
