(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-s-h-nail-ltd`;
  widget.dataset.client = "batch02_s_h_nail_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("S&H NAIL LTD private-review assistant is currently unavailable.");
