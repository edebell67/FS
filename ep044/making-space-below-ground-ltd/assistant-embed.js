(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-making-space-below-ground-ltd`;
  widget.dataset.client = "batch02_making_space_below_ground_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Making space below ground ltd private-review assistant is currently unavailable.");
