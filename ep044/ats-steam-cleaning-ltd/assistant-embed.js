(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-ats-steam-cleaning-ltd`;
  widget.dataset.client = "batch02_ats_steam_cleaning_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Ats Steam Cleaning Ltd private-review assistant is currently unavailable.");
