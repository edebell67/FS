(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-silva-building-services-ltd`;
  widget.dataset.client = "batch02_silva_building_services_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("SILVA BUILDING SERVICES LTD private-review assistant is currently unavailable.");
