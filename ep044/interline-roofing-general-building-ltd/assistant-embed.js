(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-interline-roofing-general-building-ltd`;
  widget.dataset.client = "batch02_interline_roofing_general_building_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Interline Roofing & General Building Ltd private-review assistant is currently unavailable.");
