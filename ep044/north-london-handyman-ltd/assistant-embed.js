(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-north-london-handyman-ltd`;
  widget.dataset.client = "batch02_north_london_handyman_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("NORTH LONDON HANDYMAN LTD private-review assistant is currently unavailable.");
