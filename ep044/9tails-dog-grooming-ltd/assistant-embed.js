(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-9tails-dog-grooming-ltd`;
  widget.dataset.client = "batch02_9tails_dog_grooming_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("9Tails Dog Grooming LTD private-review assistant is currently unavailable.");
