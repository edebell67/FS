(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-maison-dog-limited`;
  widget.dataset.client = "batch02_maison_dog_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("MAISON DOG LIMITED private-review assistant is currently unavailable.");
