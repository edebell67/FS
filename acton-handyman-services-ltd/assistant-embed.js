(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-acton-handyman-services-ltd`;
  widget.dataset.client = "batch02_acton_handyman_services_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Acton Handyman Services Ltd private-review assistant is currently unavailable.");
