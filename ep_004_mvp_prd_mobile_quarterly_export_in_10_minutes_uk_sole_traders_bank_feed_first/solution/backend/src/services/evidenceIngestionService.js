 ...
 * @param {string} [params.capturedAt] - Optional ISO timestamp override for deterministic imports/tests
 * @returns {Promise<Object>} The persisted evidence record
 */
async function ingestEvidence({ store, userId, fileName, type, content, capturedAt }) {
  // 1. Simulate storage
