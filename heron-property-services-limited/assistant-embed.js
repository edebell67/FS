(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-heron-property-services-limited`;
  widget.dataset.client = "batch02_heron_property_services_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Heron Property Services Limited private-review assistant is currently unavailable.");
