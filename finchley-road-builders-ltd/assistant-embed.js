(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-finchley-road-builders-ltd`;
  widget.dataset.client = "batch02_finchley_road_builders_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Finchley Road Builders Ltd private-review assistant is currently unavailable.");
