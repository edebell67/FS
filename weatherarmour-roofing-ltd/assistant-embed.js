(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-weatherarmour-roofing-ltd`;
  widget.dataset.client = "batch02_weatherarmour_roofing_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("WeatherArmour Roofing LTD private-review assistant is currently unavailable.");
