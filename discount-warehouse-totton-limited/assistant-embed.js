(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-discount-warehouse-totton-limited`;
  widget.dataset.client = "batch02_discount_warehouse_totton_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Discount Warehouse (Totton) Limited private-review assistant is currently unavailable.");
