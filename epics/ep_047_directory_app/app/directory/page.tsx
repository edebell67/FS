  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      <section className="text-center">
        ...
        <form action="/directory/search" className="mx-auto mt-6 flex max-w-lg gap-2">
          <input
            type="text"
            name="q"
      ...
      <section className="mt-12">
        <div className="mb-3 flex items-baseline justify-between">
          ...
          <Link href="/directory/search" className="text-sm font-medium text-brand-600 hover:text-brand-700">
            All categories →
          </Link>
        </div>
