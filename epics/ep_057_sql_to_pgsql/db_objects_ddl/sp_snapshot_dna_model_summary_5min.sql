...
-- Description:      Captures 5-minute periodic performance snapshots for all
--                   DNA models across both closed and open trades, replicating
--                   the metrics stored in _summary_net.json.
-- =============================================================================
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            -- Less than 5 minutes have elapsed since the last capture
            RETURN;
        END
    END
