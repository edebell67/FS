...
<!--
 * top10_5min_equity_curves.html — Top 10 Strategy Models: 5-Min Directional Split, Replay Mode, Baseline Initializer & Delta Hiding
 *
 * VERSION HISTORY
...
<head>
  ...
  <title>Top 10 Strategy Models - Replay Mode, Directional Split & Baseline Initializer</title>
...
<body class="p-2 sm:p-4 bg-slate-950 text-slate-100 antialiased min-h-screen">
      ...
      <div>
        <div class="flex items-center gap-2">
          ...
          <h1 class="text-xl sm:text-2xl font-black tracking-tight text-white font-mono">
            Top 10 Models: Replay & Directional Split
          </h1>
        </div>
        <p class="text-xs text-slate-400 mt-1">
          Play/scrub progression &bull; Inspect Total Net, <span class="text-sky-400 font-semibold">Buy Net</span> & <span class="text-amber-400 font-semibold">Sell Net</span> &bull; Toggle delta lines &bull; Re-center baseline from any timestamp
        </p>
      </div>
    ...
    <div class="mt-3 p-3 bg-slate-950 border border-slate-800 rounded-xl flex flex-col gap-2.5 shadow-lg font-mono">
      ...
      <div class="flex flex-wrap items-center justify-between gap-3 text-xs">
        <div class="flex items-center gap-2">
          ...
          <button id="restartBtn" title="Rewind to start" class="p-1.5 px-2 rounded-lg bg-slate-800 text-slate-300 hover:text-white border border-slate-700 font-bold transition">
            ↺ 00:00
          </button>
    ...
    <div class="mt-3 p-3 bg-slate-950/80 rounded-xl border border-slate-800/80 relative">
      ...
      <div class="flex flex-wrap items-center justify-between text-xs text-slate-400 pt-3 border-t border-slate-800/70 mt-2 font-mono gap-3">
        ...
        <div class="text-[11px] text-amber-300/90 flex items-center gap-1.5 ml-auto">
          ...
          <span>Tip: Click chart/scrubber to <b>Set Baseline</b> &bull; Click <b>Play</b> to animate</span>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    function updateScrubberUI() {
      ...
      // Baseline marker position on scrubber
...
print("SUCCESS: Merged Replay Engine + Directional Splits + Delta Hiding + Baseline Initializer into both locations!")
