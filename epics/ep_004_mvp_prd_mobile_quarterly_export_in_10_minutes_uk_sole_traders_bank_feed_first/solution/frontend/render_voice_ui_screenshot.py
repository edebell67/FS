...
def render(payload_path: Path, output_path: Path) -> None:
    ...
    rounded(draw, (30, 286, WIDTH - 30, 362), 24, "#fff5ea", outline="#eed6c4")
    text(draw, (48, 302), payload["legalDisclaimer"]["eyebrow"].upper(), label_font, "#9e3113")
    text(draw, (48, 322), payload["legalDisclaimer"]["title"], title_font, "#25160f")
    for index, line in enumerate(wrap(payload["legalDisclaimer"]["responsibility"], 43)):
        text(draw, (48, 344 + (index * 16)), line, small_font, "#6c5b4e")

    rounded(draw, (30, 380, WIDTH - 30, 512), 24, "#fff7ef", outline="#eedccd")
    text(draw, (48, 400), "INBOX MICRO-DECISION", label_font, "#9e3113")
    text(draw, (48, 426), payload["transaction"]["merchant"], title_font, "#25160f")
    text(draw, (48, 452), f"Amount  GBP {payload['transaction']['amount']:.2f}", body_font, "#25160f")
    text(draw, (48, 476), "Category  Travel", body_font, "#25160f")
    text(draw, (48, 496), "Business or personal  Missing", body_font, "#6c5b4e")
