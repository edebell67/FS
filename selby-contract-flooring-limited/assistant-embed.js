(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-selby-contract-flooring-limited`;
  widget.dataset.client = "batch02_selby_contract_flooring_limited";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("SELBY CONTRACT FLOORING LIMITED private-review assistant is currently unavailable.");
