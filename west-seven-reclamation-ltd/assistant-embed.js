(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-west-seven-reclamation-ltd`;
  widget.dataset.client = "batch02_west_seven_reclamation_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("West Seven Reclamation Ltd private-review assistant is currently unavailable.");
