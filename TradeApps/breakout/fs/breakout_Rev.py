...
class BreakoutStrategyWithReversal(BaseBreakoutStrategy):
    allow_reversal = True
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Live breakout strategy with reversal.')
