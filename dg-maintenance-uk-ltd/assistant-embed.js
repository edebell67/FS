(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-dg-maintenance-uk-ltd`;
  widget.dataset.client = "batch02_dg_maintenance_uk_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("DG Maintenance UK Ltd private-review assistant is currently unavailable.");
