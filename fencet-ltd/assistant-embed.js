(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-fencet-ltd`;
  widget.dataset.client = "batch02_fencet_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Fencet Ltd private-review assistant is currently unavailable.");
