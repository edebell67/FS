(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-oytics-removals-ltd`;
  widget.dataset.client = "batch02_oytics_removals_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Oytics Removals Ltd private-review assistant is currently unavailable.");
