(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-msj-drain-clearance-ltd`;
  widget.dataset.client = "batch02_msj_drain_clearance_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("MSJ Drain Clearance Ltd private-review assistant is currently unavailable.");
