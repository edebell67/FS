(() => {
  ...
  widget.src = `${apiBase}/widget.js?v=a31871e-daniel-s-home-improvements-ltd`;
  widget.dataset.client = "batch02_daniel_s_home_improvements_ltd";
  widget.dataset.apiBase = apiBase;
  widget.dataset.autoOpen = "false";
  widget.defer = true;
  widget.onerror = () => console.warn("Daniel's Home Improvements Ltd private-review assistant is currently unavailable.");
